        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6 md:p-8 lg:p-10">
          <div className="bg-gradient-to-l  from-[#40916c] to-[#2a6f97] rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="p-4 md:p-6">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold text-white">Multiplayer Arena</h2>
                  <p className="text-[#b7e4c7] mt-2">Created by Gamer123</p>
                </div>
                <GamepadIcon className="text-white h-6 w-6" />
              </div>
              <div className="mt-4 flex items-center justify-between">
                <span className="px-3 py-1 bg-[#40916c] text-white font-medium rounded-full text-sm">Live</span>
          ...
          <div className="bg-gradient-to-l  from-[#40916c] to-[#2a6f97] rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="p-4 md:p-6">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold text-white">Battle Royale</h2>
                  <p className="text-[#b7e4c7] mt-2">Created by ProGamer</p>
                </div>
                <GamepadIcon className="text-white h-6 w-6" />
              </div>
              <div className="mt-4 flex items-center justify-between">
                <span className="px-3 py-1 bg-[#ffa500] text-white font-medium rounded-full text-sm">Waiting</span>
                <Button size="sm" variant="primary">
                  Join
                  <ArrowRightIcon className="ml-2 h-4 w-4" />
                </Button>
          ...
          <div className="bg-gradient-to-l  from-[#40916c] to-[#2a6f97] rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="p-4 md:p-6">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold text-white">Deathmatch</h2>
                  <p className="text-[#b7e4c7] mt-2">Created by MLGPro</p>
                </div>
                <GamepadIcon className="text-white h-6 w-6" />
              </div>
              <div className="mt-4 flex items-center justify-between">
                <span className="px-3 py-1 bg-[#c1121f] text-white font-medium rounded-full text-sm">Offline</span>
                <Button size="sm" variant="primary">
                  Join
                  <ArrowRightIcon className="ml-2 h-4 w-4" />
                </Button>
